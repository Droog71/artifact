...
minetest.register_abm({
    ...
    action = function(pos, node, active_object_count, active_object_count_wider)
        ...
        if inv:contains_item("main", "artifact:coal_lump") then
            inv:remove_item("main", "artifact:coal_lump")
            has_fuel = true
        elseif inv:contains_item("main", "artifact:stick") then
            inv:remove_item("main", "artifact:stick")
            has_fuel = true
        end 
        local active = is_producer(pos)
        if has_fuel then
